...
from cistar_dev.controllers.car_following_models import OVMController
...
type_params = {"rl":(auton_cars, (RLController, {}), (StaticLaneChanger, {}), 0), 
            "ovm": (human_cars, (OVMController, {}), (StaticLaneChanger, {}), 0)}

env_params = {"target_velocity": 25, "max-vel":35, "min-vel":0, "max-deacc": 6, "max-acc":5}

net_params = {"length": 220, "lanes": 1, "speed_limit":35, "resolution": 40, "net_path":"emission/rl/net/"}
...
scenario = LoopScenario("rl-emission-accel-test", type_params, net_params, cfg_params, initial_config=initial_config)
...
for seed in [1]: # [1, 5, 10, 73, 56]
    ...
    run_experiment_lite(
        ...
        seed=seed,
        mode="local",
        exp_prefix="rl-emission-accel-test"
        # plot=True,
    )
