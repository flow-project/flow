...
# MAKE SURE FAILSAFES ARE OFF. If they don't, the poisson arrival
# times get broken by the fail-safe for high intensity. This NEEDS to be fixed. 
...
exp_tag = str(num_cars) + '-car-' + '-rl-intersection-control'
