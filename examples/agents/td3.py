...
# """
# TODO: replay_starts needs to be different
# """

# policy = DDPGTFPolicy
# #  self.critic_loss, self.actor_loss, self.td_error
# extra_metrics = {"critic_loss": policy.critic_loss,
#                 "agent_loss": policy.agent_loss,
#                 "td_error": policy.td_error
#                 }
# policy.stats.update(extra_metrics)
# CustomTD3Trainer = TD3Trainer.with_updates(
#     defaultpolicy=policy
# )
# # trainer = TD3Trainer.withupdates(
# #     defaultpolicy
# # )
...
class DDPGTFPolicy(DDPGPostprocessing, TFPolicy):
    def __init__(self, observation_space, action_space, config):
        ...
        self.stats.update({"critic_loss": self.critic_loss,
...
CustomTD3Trainer = DDPGTrainer.with_updates(name="TD3", default_policy=DDPGTFPolicy, default_config=TD3_DEFAULT_CONFIG)

# if __name__=="__main__":
#     TD3Trainer = DDPGTrainer.with_updates(name="TD3", default_policy=DDPGTFPolicy, default_config=TD3_DEFAULT_CONFIG)
