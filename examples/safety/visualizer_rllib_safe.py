...
from examples.safety.safe_rl_ring import flow_params
...
result_dir_policy = "../../examples/safety/data/trained_ring"


def visualizer_rllib(args, flow_params):
    """Visualizer for RLlib experiments.
...
if __name__ == '__main__':
    ...
    ray.init(num_cpus=1)
    visualizer_rllib(args, flow_params)


# python flow/visualize/visualizer_rllib_safe.py examples/safety/data/trained_ring 200 --horizon 2000