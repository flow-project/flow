...
vehicle_params = [dict(veh_id="rl",
                       ...
                       num_vehicles=RL_VEHICLES / 2 * SCALING,
...
def make_create_env(flow_env_name, flow_params, version=0, exp_tag="example", sumo="sumo-gui"):
...
if __name__ == "__main__":
    ...
    n_rollouts = 2
    num_iters = 1000
    flow_env_name = "BottleneckMAEnv"
    exp_tag = "multiagent_bay_bridge"  # experiment prefix
    ...
    options = {"multiagent_obs_shapes": [OBS_SPACE + 5 * (MAX_RL_VEHICLES - 1)] * MAX_RL_VEHICLES,
               "multiagent_act_shapes": [2] * MAX_RL_VEHICLES,
               "is_shared_model": True,
               "multiagent_shared_model": True,
               "multiagent_hiddens": [[256, 256]] * MAX_RL_VEHICLES,
