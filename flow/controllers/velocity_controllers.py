    ...
    def get_accel(self, env):
        ...
        if env.time_counter < env.env_params.warmup_steps * env.env_params.sims_per_step:
            ...
            if (self.find_intersection_dist(env) <= 10 and \
                    ...
                    and env.k.vehicle.get_x_by_id(self.veh_id) > self.control_length[1]) or \
                    (self.no_control_edges and len(self.no_control_edges) > 0 and env.k.vehicle.get_edge(self.veh_id) not in self.no_control_edges):
