...
import ray
from flow.algorithms.qmix.mixers import VDNMixer, QMixer
from flow.algorithms.qmix.model import RNNModel, _get_size, FeedForward
...
class QMixTorchPolicy(Policy):
    ...
    def __init__(self, obs_space, action_space, config):
        ...
        self.model = ModelCatalog.get_model_v2(
            ...
            # TODO(@evinitsky) make an RNN an option
