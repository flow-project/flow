...
class ShepherdingGenerator(CircleGenerator):
    def make_routes(self, scenario, initial_config):
        if initial_config.additional_params and initial_config.additional_params['rl_out_front']:
            ...
            if vehicles.num_vehicles > 0:
                ...
                if initial_config.additional_params["rl_position"]:
                    rl_position = initial_config.additional_params["rl_position"]
                else:
                    rl_position = ('bottom', 305)
                positions = [rl_position] * 3
                lanes = [0,1,2]
            ...
            super().make_routes(scenario, initial_config)