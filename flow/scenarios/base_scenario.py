...
class Scenario(Serializable):
    ...
    def generate_starting_positions(self, **kwargs):
        ...
        if self.initial_config.spacing == "uniform":
            ...
            startpositions, startlanes = self.gen_random_start_pos(self.initial_config, **kwargs)
        elif self.initial_config.spacing == "gen_no_overlap_lane_starts":
            startpositions, startlanes = self.gen_no_overlap_lane_starts(self.initial_config, **kwargs)
        elif self.initial_config.spacing == "uniform_in_lane":
            startpositions, startlanes = self.get_uniform_in_lane(self.initial_config, **kwargs)
