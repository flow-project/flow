...
class WaveAttenuationMergePOEnv(Env):
    ...
    zeros, effectively silencing their effect on the hidden states of the
    neural net, and consequently on the generated actions. Conversely, if the
    number of autonomous vehicles is greater than "num_rl", the observations
    from the additional vehicles are not included in the state space.
