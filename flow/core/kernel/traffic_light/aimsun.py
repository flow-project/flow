...
class AimsunKernelTrafficLight(KernelTrafficLight):
    ...
    * State acquisition: This methods contains several methods for acquiring
    ...
    def get_ids(self):
        ...
        return None  # FIXME: call aimsun's API for this, or store separately
    ...
    # TODO added lane_id (double check there is error) change node id to meter id
    # @Yashar, we pass a string with the states of all lights, I'll show you
    ...
    def num_traffic_lights(self):
        # TODO: fill in with appropriate API call
        return None
