...
def run_transfer_test(args, flow_params, transfer_fn, rllib_config=None):
...
def create_parser():
    ...
    parser.add_argument(
        '--rllib_result_dir', required=False, type=str, help='Directory containing results')
    parser.add_argument('--checkpoint_num', required=False, type=str, help='Checkpoint number.')
